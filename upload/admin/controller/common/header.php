...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_lprice'] = $this->language->get('text_lprice');
		$this->data['text_discount'] = $this->language->get('text_discount');
		$this->data['text_uprice'] = $this->language->get('text_uprice');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['discount'] = $this->url->link('localisation/discount', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['uprice'] = $this->url->link('tool/update_price', 'token=' . $this->session->data['token'], 'SSL');
