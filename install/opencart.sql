...
--
-- Хост: localhost
-- Время создания: Май 27 2015 г., 17:29
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Мар 19 2015 г., 17:20
--
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Янв 06 2015 г., 18:31
--
...
--
-- Создание: Май 27 2015 г., 14:25
-- Последнее обновление: Май 27 2015 г., 14:25
--
...
--
-- Создание: Мар 06 2015 г., 07:06
-- Последнее обновление: Мар 06 2015 г., 07:06
--
...
(81, 'Германия', 'DE', 'DEU', '{company}\r\n{firstname} {lastname}{address_1}{address_2}{postcode} {city}{country}', 0, 1),
(82, 'Гана', 'GH', 'GHA', '', 0, 1),
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Май 27 2015 г., 14:13
-- Последняя проверка: Мар 05 2015 г., 12:27
--
...
(4, 'Pound Sterling', 'GBP', '£', '', '2', 0.01270000, 1, '2015-05-27 10:56:38'),
(2, 'US Dollar', 'USD', '$', '', '2', 0.01950000, 1, '2015-05-27 10:56:38'),
(3, 'Euro', 'EUR', '', '€', '2', 0.01790000, 1, '2015-05-27 10:56:38'),
(1, 'Рубль', 'RUB', '', ' руб', '2', 1.00000000, 1, '2015-05-27 17:13:10');
-- --------------------------------------------------------
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Мар 19 2015 г., 17:34
--
...
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Янв 06 2015 г., 18:31
-- Последняя проверка: Янв 06 2015 г., 18:31
--
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Мар 19 2015 г., 13:09
-- Последняя проверка: Янв 06 2015 г., 18:31
--
...
--
-- Структура таблицы `oc_discount`
--
-- Создание: Янв 06 2015 г., 18:31
--

DROP TABLE IF EXISTS `oc_discount`;
CREATE TABLE IF NOT EXISTS `oc_discount` (
  `discount_id` int(11) unsigned NOT NULL,
  `sort_order` int(3) NOT NULL,
  `min_price` int(11) NOT NULL,
  `max_price` int(11) NOT NULL,
  `percent` float(6,2) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `oc_discount`
--

INSERT INTO `oc_discount` (`discount_id`, `sort_order`, `min_price`, `max_price`, `percent`) VALUES
(1, 1, 100, 300, 10.00),
(2, 2, 300, 800, 30.00),
(3, 3, 800, 10000, 15.00);
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Май 27 2015 г., 11:31
--
...
(59, 'total', 'total'),
(387, 'shipping', 'flat'),
(413, 'module', 'categories'),
(433, 'module', 'alys_discount_box'),
(408, 'module', 'account'),
(432, 'payment', 'bank_transfer'),
(427, 'module', 'featured'),
(437, 'module', 'tehnomir'),
(429, 'module', 'manufacturer'),
(430, 'module', 'welcome'),
(431, 'module', 'simple'),
(435, 'module', 'cachemanager'),
(436, 'module', 'deadcow_seo'),
(438, 'module', '1000_categories_accordion');
...
(5, 'Все регионы России', 'Все регионы России', '0000-00-00 00:00:00', '2014-08-08 16:42:31');
...
(4, 1, 'О нас', '&lt;p&gt;\r\n	О нас&lt;/p&gt;\r\n'),
(5, 1, 'Условия использования', '&lt;p&gt;\r\n	Условия использования&lt;/p&gt;\r\n'),
(3, 1, 'Политика безопасности', '&lt;p&gt;\r\n	Политика безопасности&lt;/p&gt;\r\n'),
(6, 1, 'Информация о поставке', '&lt;p&gt;\r\n	Информация о поставке&lt;/p&gt;\r\n');
...
(1, 'Russian', 'ru', 'en_US.UTF-8,en_US,en-gb,english', 'ru.png', 'russian', 'russian', 1, 1);
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Май 27 2015 г., 08:15
--
...
--
-- Дамп данных таблицы `oc_menu`
--

INSERT INTO `oc_menu` (`menu_id`, `parent_id`, `href`, `class`, `type`, `subcategory`, `top`, `column`, `sort_order`, `status`) VALUES
(1, 0, '/', '', 0, 0, 1, 1, 1, 1),
(2, 0, 'information/information&amp;information_id=4', '', 3, 0, 1, 1, 2, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `oc_menuitems`
--
-- Создание: Янв 06 2015 г., 18:31
--

DROP TABLE IF EXISTS `oc_menuitems`;
CREATE TABLE IF NOT EXISTS `oc_menuitems` (
...
--
-- Структура таблицы `oc_menuitem_descriptions`
--
-- Создание: Янв 06 2015 г., 18:31
--

DROP TABLE IF EXISTS `oc_menuitem_descriptions`;
CREATE TABLE IF NOT EXISTS `oc_menuitem_descriptions` (
  `menu_item_id` int(11) unsigned NOT NULL,
...
--
-- Дамп данных таблицы `oc_menu_description`
--
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Мар 19 2015 г., 17:29
--
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Мар 19 2015 г., 17:26
--
...
CREATE TABLE IF NOT EXISTS `oc_product` (
  ...
  `price` decimal(15,4) NOT NULL DEFAULT '0.0000',
  `price_import` decimal(15,4) NOT NULL DEFAULT '0.0000',
...
--
-- Создание: Мар 19 2015 г., 19:09
-- Последнее обновление: Мар 19 2015 г., 19:09
--
...
CREATE TABLE IF NOT EXISTS `oc_product_description` (
  ...
  `meta_keyword` varchar(255) NOT NULL,
  `tag` text NOT NULL,
  `_firm` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `_country` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `_mancode` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `_articul` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Создание: Мар 19 2015 г., 19:09
-- Последнее обновление: Май 26 2015 г., 18:06
--
...
--
-- Создание: Янв 06 2015 г., 18:31
-- Последнее обновление: Май 27 2015 г., 11:32
--
...
) ENGINE=MyISAM AUTO_INCREMENT=10160 DEFAULT CHARSET=utf8;
...
(964, 0, 'carousel', 'carousel_module', 'a:1:{i:0;a:9:{s:9:"banner_id";s:1:"8";s:5:"limit";s:1:"5";s:6:"scroll";s:1:"3";s:5:"width";s:2:"80";s:6:"height";s:2:"80";s:9:"layout_id";s:1:"1";s:8:"position";s:14:"content_bottom";s:6:"status";s:1:"0";s:10:"sort_order";s:2:"-1";}}', 1),
(1793, 0, 'featured', 'featured_module', 'a:1:{i:0;a:7:{s:5:"limit";s:1:"6";s:11:"image_width";s:2:"80";s:12:"image_height";s:2:"80";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"2";}}', 1),
(2010, 0, 'category', 'categories_module', 'a:4:{i:0;a:4:{s:9:"layout_id";s:1:"4";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"2";}i:1;a:4:{s:9:"layout_id";s:1:"2";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:0:"";}i:2;a:4:{s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:0:"";}i:3;a:4:{s:9:"layout_id";s:1:"1";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:0:"";}}', 1),
...
(4194, 0, 'welcome', 'welcome_module', 'a:1:{i:1;a:5:{s:11:"description";a:1:{i:1;s:0:"";}s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"0";}}', 1),
(10156, 0, 'categories', 'categories_module', 'a:4:{i:0;a:4:{s:9:"layout_id";s:1:"4";s:8:"position";s:11:"column_left";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"2";}i:1;a:4:{s:9:"layout_id";s:1:"2";s:8:"position";s:11:"column_left";s:6:"status";s:1:"0";s:10:"sort_order";s:0:"";}i:2;a:4:{s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:6:"status";s:1:"0";s:10:"sort_order";s:0:"";}i:3;a:4:{s:9:"layout_id";s:1:"1";s:8:"position";s:11:"column_left";s:6:"status";s:1:"0";s:10:"sort_order";s:0:"";}}', 1),
(10155, 0, 'config', 'config_google_analytics', '', 0),
(10153, 0, 'config', 'config_error_log', '1', 0),
(2023, 0, 'slideshow', 'slideshow_module', 'a:1:{i:0;a:7:{s:9:"banner_id";s:1:"7";s:5:"width";s:3:"980";s:6:"height";s:3:"280";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"1";}}', 1),
(2022, 0, 'banner', 'banner_module', 'a:1:{i:0;a:7:{s:9:"banner_id";s:1:"6";s:5:"width";s:3:"182";s:6:"height";s:3:"182";s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"3";}}', 1),
(10159, 0, 'manufacturer', 'manufacturer_module', 'a:1:{i:0;a:4:{s:9:"layout_id";s:1:"1";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"2";}}', 1),
(2224, 0, 'shipping', 'shipping_sort_order', '3', 0),
(2, 0, 'sub_total', 'sub_total_sort_order', '1', 0),
(3, 0, 'sub_total', 'sub_total_status', '1', 0),
(2221, 0, 'total', 'total_sort_order', '9', 0),
(2220, 0, 'total', 'total_status', '0', 0),
(3467, 0, 'bank_transfer', 'bank_transfer_sort_order', '1', 0),
(3472, 0, 'cod', 'cod_sort_order', '2', 0),
(3471, 0, 'cod', 'cod_status', '0', 0),
(3470, 0, 'cod', 'cod_geo_zone_id', '0', 0),
(2223, 0, 'shipping', 'shipping_status', '0', 0),
(2222, 0, 'shipping', 'shipping_estimator', '1', 0),
(3466, 0, 'bank_transfer', 'bank_transfer_status', '1', 0),
(2361, 0, 'flat', 'flat_sort_order', '1', 0),
(2360, 0, 'flat', 'flat_status', '1', 0),
(2359, 0, 'flat', 'flat_geo_zone_id', '0', 0),
(2358, 0, 'flat', 'flat_tax_class_id', '0', 0),
(39, 0, 'featured', 'featured_product', '43,40,42,49,46,47,28', 0),
(2357, 0, 'flat', 'flat_cost', '0', 0),
(10154, 0, 'config', 'config_error_filename', 'error.txt', 0),
(10152, 0, 'config', 'config_error_display', '0', 0),
(10151, 0, 'config', 'config_compression', '0', 0),
(10150, 0, 'config', 'config_encryption', '0a64405742dcc034731344c7da84b30e', 0),
(10148, 0, 'config', 'config_maintenance', '0', 0),
(10149, 0, 'config', 'config_password', '1', 0),
(10141, 0, 'config', 'config_sms_gate_password', 'a1234560-4575', 0),
(10142, 0, 'config', 'config_secure', '0', 0),
(10143, 0, 'config', 'config_shared', '0', 0),
(10144, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(3464, 0, 'bank_transfer', 'bank_transfer_order_status_id', '1', 0),
(3695, 0, 'simple', 'simple_customer_two_column', '1', 0),
(3694, 0, 'simple', 'simple_googleapi_key', '', 0),
(10147, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/jpeg\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/vnd.microsoft.icon\r\nimage/tiff\r\nimage/tiff\r\nimage/svg+xml\r\nimage/svg+xml\r\napplication/zip\r\napplication/x-rar-compressed\r\napplication/x-msdownload\r\napplication/vnd.ms-cab-compressed\r\naudio/mpeg\r\nvideo/quicktime\r\nvideo/quicktime\r\napplication/pdf\r\nimage/vnd.adobe.photoshop\r\napplication/postscript\r\napplication/postscript\r\napplication/postscript\r\napplication/msword\r\napplication/rtf\r\napplication/vnd.ms-excel\r\napplication/vnd.ms-powerpoint\r\napplication/vnd.oasis.opendocument.text\r\napplication/vnd.oasis.opendocument.spreadsheet', 0),
(10145, 0, 'config', 'config_seo_url', '1', 0),
(10146, 0, 'config', 'config_file_extension_allowed', 'txt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc\r\nrtf\r\nxls\r\nppt\r\nodt\r\nods', 0),
(10140, 0, 'config', 'config_sms_gate_username', 'autosoft', 0),
(10139, 0, 'config', 'config_sms_message', 'тел.  {PHONE} \r\nЗаказ:{ID} на сумму {SUMREAL}', 0),
(10137, 0, 'config', 'config_sms_copy', '', 0),
(10138, 0, 'config', 'config_sms_phone2shipping', '', 0),
(10131, 0, 'config', 'config_sms_alert_client', '1', 0),
(10132, 0, 'config', 'config_sms_message2client', 'Ваш заказ №{ID} принят. Мы свяжемся с Вами в ближайшее время', 0),
(10136, 0, 'config', 'config_sms_to', '79219355394', 0),
(10135, 0, 'config', 'config_sms_from', 'im-autosoft', 0),
(10134, 0, 'config', 'config_sms_message2status', '{COMMENT}', 0),
(10133, 0, 'config', 'config_sms_alert_status', '1', 0),
(10130, 0, 'config', 'config_sms_alert_admin', '1', 0),
(10129, 0, 'config', 'config_sms_gatename', 'smscabNew', 0),
(10128, 0, 'config', 'config_sms_alert', '1', 0),
(10127, 0, 'config', 'config_fraud_status_id', '7', 0),
(10126, 0, 'config', 'config_fraud_score', '', 0),
(10125, 0, 'config', 'config_fraud_key', '', 0),
(10124, 0, 'config', 'config_fraud_detection', '0', 0),
(10123, 0, 'config', 'config_alert_emails', '', 0),
(10122, 0, 'config', 'config_account_mail', '0', 0),
(10121, 0, 'config', 'config_alert_mail', '0', 0),
(10120, 0, 'config', 'config_smtp_timeout', '5', 0),
(10119, 0, 'config', 'config_smtp_port', '25', 0),
(10118, 0, 'config', 'config_smtp_password', '', 0),
(10117, 0, 'config', 'config_smtp_username', '', 0),
(10116, 0, 'config', 'config_smtp_host', '', 0),
(10115, 0, 'config', 'config_mail_parameter', '', 0),
(10114, 0, 'config', 'config_mail_protocol', 'mail', 0),
(10113, 0, 'config', 'config_ftp_status', '0', 0),
(10112, 0, 'config', 'config_ftp_root', '', 0),
(10111, 0, 'config', 'config_ftp_password', '', 0),
(3465, 0, 'bank_transfer', 'bank_transfer_geo_zone_id', '0', 0),
(3462, 0, 'bank_transfer', 'bank_transfer_bank_1', ' Счет для оплаты будет выслан менеджером, после согласования заказа', 0),
(3693, 0, 'simple', 'simple_googleapi', '0', 0),
(3692, 0, 'simple', 'simple_shipping_titles', 'a:1:{s:4:"flat";a:3:{s:4:"show";s:1:"0";s:5:"title";a:1:{s:2:"ru";s:62:"Фиксированная стоимость доставки";}s:11:"description";a:1:{s:2:"ru";s:0:"";}}}', 1),
(3686, 0, 'simple', 'simple_joomla_path', '', 0),
(3687, 0, 'simple', 'simple_joomla_route', '', 0),
(3688, 0, 'simple', 'simple_header_tag', 'h3', 0),
(3689, 0, 'simple', 'simple_headers', 'a:2:{s:11:"header_main";a:3:{s:2:"id";s:11:"header_main";s:5:"label";a:1:{s:2:"ru";s:37:"Основная информация";}s:5:"place";s:8:"customer";}s:14:"header_address";a:3:{s:2:"id";s:14:"header_address";s:5:"label";a:1:{s:2:"ru";s:10:"Адрес";}s:5:"place";s:8:"customer";}}', 1),
(3690, 0, 'simple', 'restore', '0', 0),
(3691, 0, 'simple', 'simple_payment_titles', 'a:1:{s:13:"bank_transfer";a:3:{s:4:"show";s:1:"0";s:5:"title";a:1:{s:2:"ru";s:35:"Банковский перевод";}s:11:"description";a:1:{s:2:"ru";s:0:"";}}}', 1),
(3676, 0, 'simple', 'simple_registration_agreement_checkbox', '1', 0),
(3677, 0, 'simple', 'simple_registration_agreement_checkbox_init', '0', 0),
(3678, 0, 'simple', 'simple_registration_captcha', '0', 0),
(3679, 0, 'simple', 'simple_registration_subscribe', '1', 0),
(3680, 0, 'simple', 'simple_registration_subscribe_init', '1', 0),
(3681, 0, 'simple', 'simple_registration_view_customer_type', '1', 0),
(3682, 0, 'simple', 'simple_set_registration', 'a:1:{s:5:"group";a:1:{i:1;s:106:"header_main,main_email,main_firstname,main_lastname,main_telephone,header_address,main_city,main_address_1";}}', 1),
(3685, 0, 'simple', 'simple_set_account_address', 'a:1:{s:5:"group";a:1:{i:1;s:96:"main_firstname,main_lastname,main_country_id,main_zone_id,main_city,main_postcode,main_address_1";}}', 1),
(3684, 0, 'simple', 'simple_set_account_info', 'a:1:{s:5:"group";a:1:{i:1;s:63:"main_email,main_firstname,main_lastname,main_telephone,main_fax";}}', 1),
(3683, 0, 'simple', 'simple_account_view_customer_type', '0', 0),
(3675, 0, 'simple', 'simple_registration_agreement_id', '0', 0),
(3674, 0, 'simple', 'simple_registration_password_length_max', '20', 0),
(3673, 0, 'simple', 'simple_registration_password_length_min', '4', 0),
(3672, 0, 'simple', 'simple_registration_password_confirm', '0', 0),
(3669, 0, 'simple', 'placeholder_ru', '', 0),
(3670, 0, 'simple', 'simple_registration_view_email_confirm', '0', 0),
(3671, 0, 'simple', 'simple_registration_generate_password', '1', 0),
(3668, 0, 'simple', 'mask', '', 0),
(3667, 0, 'simple', 'save_to', '', 0),
(3666, 0, 'simple', 'validation_error_ru', '', 0),
(3665, 0, 'simple', 'validation_regexp', '', 0),
(3664, 0, 'simple', 'validation_max', '', 0),
(3663, 0, 'simple', 'validation_min', '', 0),
(3662, 0, 'simple', 'validation_type', '0', 0),
(3661, 0, 'simple', 'values_ru', '', 0),
(3660, 0, 'simple', 'date_only_for', '', 0),
(3659, 0, 'simple', 'date_end', '', 0),
(3658, 0, 'simple', 'date_max', '', 0),
(3657, 0, 'simple', 'date_start', '', 0),
(3656, 0, 'simple', 'date_min', '', 0),
(3655, 0, 'simple', 'place', 'customer', 0),
(3654, 0, 'simple', 'type', 'text', 0),
(3653, 0, 'simple', 'object_field', '', 0),
(3650, 0, 'simple', 'id', '', 0),
(3651, 0, 'simple', 'label_ru', '', 0),
(3652, 0, 'simple', 'object_type', 'order', 0),
(3645, 0, 'simple', 'simple_links', 'a:1:{s:13:"bank_transfer";s:0:"";}', 1),
(3646, 0, 'simple', 'simple_links_2', 'a:2:{s:4:"flat";s:0:"";s:19:"simple_links_2_stub";s:0:"";}', 1),
(3647, 0, 'simple', 'simple_group_payment', 'a:1:{i:1;s:0:"";}', 1),
(3648, 0, 'simple', 'simple_group_shipping', 'a:1:{i:1;s:0:"";}', 1),
(3649, 0, 'simple', 'simple_fields_main', 'a:15:{s:10:"main_email";a:16:{s:2:"id";s:10:"main_email";s:5:"label";a:1:{s:2:"ru";s:6:"E-mail";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"3";s:17:"validation_regexp";s:56:"/^[a-z0-9_\\.\\-]{1,20}@[a-z0-9\\.\\-]{1,20}\\.[a-z]{2,4}$/si";s:16:"validation_error";a:1:{s:2:"ru";s:62:"Ошибка в адресе электронной почты";}s:7:"save_to";s:5:"email";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:14:"main_firstname";a:18:{s:2:"id";s:14:"main_firstname";s:5:"label";a:1:{s:2:"ru";s:6:"Имя";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"2";s:14:"validation_min";s:1:"1";s:14:"validation_max";s:2:"30";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:60:"Имя должно быть от 1 до 30 символов";}s:7:"save_to";s:9:"firstname";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:13:"main_lastname";a:18:{s:2:"id";s:13:"main_lastname";s:5:"label";a:1:{s:2:"ru";s:14:"Фамилия";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"2";s:14:"validation_min";s:1:"1";s:14:"validation_max";s:2:"30";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:68:"Фамилия должно быть от 1 до 30 символов";}s:7:"save_to";s:8:"lastname";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:14:"main_telephone";a:18:{s:2:"id";s:14:"main_telephone";s:5:"label";a:1:{s:2:"ru";s:14:"Телефон";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"2";s:14:"validation_min";s:1:"3";s:14:"validation_max";s:2:"32";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:69:"Телефон должен быть от 3 до 32 символов!";}s:7:"save_to";s:9:"telephone";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:8:"main_fax";a:18:{s:2:"id";s:8:"main_fax";s:5:"label";a:1:{s:2:"ru";s:8:"Факс";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"0";s:14:"validation_min";s:0:"";s:14:"validation_max";s:0:"";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:0:"";}s:7:"save_to";s:3:"fax";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:12:"main_company";a:18:{s:2:"id";s:12:"main_company";s:5:"label";a:1:{s:2:"ru";s:16:"Компания";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"0";s:14:"validation_min";s:0:"";s:14:"validation_max";s:0:"";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:0:"";}s:7:"save_to";s:7:"company";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:15:"main_company_id";a:18:{s:2:"id";s:15:"main_company_id";s:5:"label";a:1:{s:2:"ru";s:10:"Company ID";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"0";s:14:"validation_min";s:0:"";s:14:"validation_max";s:0:"";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:0:"";}s:7:"save_to";s:10:"company_id";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:11:"main_tax_id";a:18:{s:2:"id";s:11:"main_tax_id";s:5:"label";a:1:{s:2:"ru";s:6:"Tax ID";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"0";s:14:"validation_min";s:0:"";s:14:"validation_max";s:0:"";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:0:"";}s:7:"save_to";s:6:"tax_id";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:14:"main_address_1";a:18:{s:2:"id";s:14:"main_address_1";s:5:"label";a:1:{s:2:"ru";s:10:"Адрес";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"2";s:14:"validation_min";s:1:"3";s:14:"validation_max";s:3:"128";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:65:"Адрес должен быть от 3 до 128 символов";}s:7:"save_to";s:9:"address_1";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:14:"main_address_2";a:18:{s:2:"id";s:14:"main_address_2";s:5:"label";a:1:{s:2:"ru";s:35:"Адрес (продолжение)";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"0";s:14:"validation_min";s:0:"";s:14:"validation_max";s:0:"";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:0:"";}s:7:"save_to";s:9:"address_2";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:13:"main_postcode";a:18:{s:2:"id";s:13:"main_postcode";s:5:"label";a:1:{s:2:"ru";s:12:"Индекс";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"0";s:14:"validation_min";s:1:"2";s:14:"validation_max";s:2:"10";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:83:"Почтовый индекс должен быть от 2 до 10 символов";}s:7:"save_to";s:8:"postcode";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:15:"main_country_id";a:18:{s:2:"id";s:15:"main_country_id";s:5:"label";a:1:{s:2:"ru";s:12:"Страна";}s:4:"type";s:6:"select";s:6:"values";s:9:"countries";s:4:"init";s:3:"176";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:14:"validation_min";s:0:"";s:14:"validation_max";s:0:"";s:17:"validation_regexp";s:0:"";s:15:"validation_type";s:1:"4";s:16:"validation_error";a:1:{s:2:"ru";s:50:"Пожалуйста выберите страну";}s:7:"save_to";s:10:"country_id";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:12:"main_zone_id";a:18:{s:2:"id";s:12:"main_zone_id";s:5:"label";a:1:{s:2:"ru";s:12:"Регион";}s:4:"type";s:6:"select";s:6:"values";s:5:"zones";s:4:"init";s:4:"2761";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:14:"validation_min";s:0:"";s:14:"validation_max";s:0:"";s:17:"validation_regexp";s:0:"";s:15:"validation_type";s:1:"4";s:16:"validation_error";a:1:{s:2:"ru";s:50:"Пожалуйста выберите регион";}s:7:"save_to";s:7:"zone_id";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:9:"main_city";a:18:{s:2:"id";s:9:"main_city";s:5:"label";a:1:{s:2:"ru";s:10:"Город";}s:4:"type";s:4:"text";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"2";s:14:"validation_min";s:1:"2";s:14:"validation_max";s:3:"128";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:65:"Город должен быть от 2 до 128 символов";}s:7:"save_to";s:4:"city";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}s:12:"main_comment";a:18:{s:2:"id";s:12:"main_comment";s:5:"label";a:1:{s:2:"ru";s:22:"Комментарий";}s:4:"type";s:8:"textarea";s:6:"values";a:1:{s:2:"ru";s:0:"";}s:4:"init";s:0:"";s:8:"date_min";s:0:"";s:10:"date_start";s:0:"";s:8:"date_max";s:0:"";s:8:"date_end";s:0:"";s:13:"date_only_for";s:0:"";s:15:"validation_type";s:1:"0";s:14:"validation_min";s:0:"";s:14:"validation_max";s:0:"";s:17:"validation_regexp";s:0:"";s:16:"validation_error";a:1:{s:2:"ru";s:0:"";}s:7:"save_to";s:7:"comment";s:4:"mask";s:0:"";s:11:"placeholder";a:1:{s:2:"ru";s:0:"";}}}', 1),
(3643, 0, 'simple', 'shipping_code_for_customer_1', '', 0),
(3644, 0, 'simple', 'shipping_code_for_shipping_1', '', 0),
(3641, 0, 'simple', 'simple_shipping_address_geo_selector_type', '1', 0),
(3642, 0, 'simple', 'simple_set_checkout_address', 'a:3:{s:5:"group";a:1:{i:1;s:96:"main_firstname,main_lastname,main_country_id,main_zone_id,main_city,main_postcode,main_address_1";}s:8:"shipping";a:1:{i:1;a:1:{s:4:"flat";s:0:"";}}s:7:"payment";a:1:{i:1;a:1:{s:13:"bank_transfer";s:0:"";}}}', 1),
(3640, 0, 'simple', 'simple_shipping_address_use_geo_selector', '0', 0),
(3638, 0, 'simple', 'simple_show_shipping_address_same_show', '0', 0),
(3639, 0, 'simple', 'simple_shipping_view_address_select', '0', 0),
(3632, 0, 'simple', 'simple_customer_geo_selector_type', '1', 0),
(3633, 0, 'simple', 'simple_customer_view_customer_type', '0', 0),
(3634, 0, 'simple', 'simple_set_checkout_customer', 'a:3:{s:5:"group";a:1:{i:1;s:131:"header_main,main_email,main_firstname,main_lastname,main_telephone,split_split,header_address,main_city,main_address_1,main_comment";}s:8:"shipping";a:1:{i:1;a:1:{s:4:"flat";s:0:"";}}s:7:"payment";a:1:{i:1;a:1:{s:13:"bank_transfer";s:0:"";}}}', 1),
(3637, 0, 'simple', 'simple_show_shipping_address_same_init', '1', 0),
(3635, 0, 'simple', 'simple_address_hide_if_logged', '0', 0),
(3636, 0, 'simple', 'simple_show_shipping_address', '0', 0),
(3631, 0, 'simple', 'simple_customer_use_geo_selector', '0', 0),
(3630, 0, 'simple', 'simple_customer_view_address_select', '0', 0),
(3629, 0, 'simple', 'simple_customer_view_login', '1', 0),
(3628, 0, 'simple', 'simple_customer_view_customer_subscribe_init', '1', 0),
(3627, 0, 'simple', 'simple_customer_action_subscribe', '0', 0),
(3626, 0, 'simple', 'simple_customer_view_password_length_max', '20', 0),
(3625, 0, 'simple', 'simple_customer_view_password_length_min', '4', 0),
(3624, 0, 'simple', 'simple_customer_view_password_confirm', '0', 0),
(3623, 0, 'simple', 'simple_customer_generate_password', '0', 0),
(3622, 0, 'simple', 'simple_customer_view_customer_register_init', '0', 0),
(3620, 0, 'simple', 'simple_customer_view_email', '2', 0),
(3621, 0, 'simple', 'simple_customer_view_email_confirm', '0', 0),
(3618, 0, 'simple', 'simple_show_will_be_registered', '0', 0),
(3619, 0, 'simple', 'simple_customer_action_register', '0', 0),
(3617, 0, 'simple', 'simple_customer_hide_if_logged', '0', 0),
(3616, 0, 'simple', 'simple_payment_view_address_full', 'a:1:{s:13:"bank_transfer";s:1:"0";}', 1),
(3615, 0, 'simple', 'simple_payment_view_autoselect_first', '1', 0),
(3614, 0, 'simple', 'simple_payment_view_address_empty', '1', 0),
(3613, 0, 'simple', 'simple_payment_methods_hide', '1', 0),
(3611, 0, 'simple', 'simple_shipping_view_autoselect_first', '1', 0),
(3612, 0, 'simple', 'simple_shipping_view_address_full', 'a:1:{s:4:"flat";s:1:"0";}', 1),
(3610, 0, 'simple', 'simple_shipping_view_address_empty', '0', 0),
(3609, 0, 'simple', 'simple_shipping_view_title', '1', 0),
(3608, 0, 'simple', 'simple_shipping_methods_hide', '1', 0),
(3606, 0, 'simple', 'simple_common_view_help_id', '0', 0),
(3607, 0, 'simple', 'simple_common_view_help_text', '0', 0),
(3605, 0, 'simple', 'simple_common_view_agreement_checkbox_init', '0', 0),
(3604, 0, 'simple', 'simple_common_view_agreement_checkbox', '0', 0),
(3603, 0, 'simple', 'simple_common_view_agreement_text', '0', 0),
(3602, 0, 'simple', 'simple_common_view_agreement_id', '0', 0),
(3601, 0, 'simple', 'simple_max_weight', '', 0),
(3600, 0, 'simple', 'simple_min_weight', '', 0),
(3599, 0, 'simple', 'simple_max_quantity', '', 0),
(3598, 0, 'simple', 'simple_min_quantity', '', 0),
(3597, 0, 'simple', 'simple_max_amount', '', 0),
(3596, 0, 'simple', 'simple_min_amount', '', 0),
(3595, 0, 'simple', 'simple_show_weight', '0', 0),
(3594, 0, 'simple', 'simple_use_total', '0', 0),
(3593, 0, 'simple', 'simple_childs_payment_first', '0', 0),
(3592, 0, 'simple', 'simple_minify', '0', 0),
(3591, 0, 'simple', 'simple_comment_target', '', 0),
(3589, 0, 'simple', 'simple_type_of_selection_of_group', 'radio', 0),
(3590, 0, 'simple', 'simple_customer_group_id_after_reg', '1', 0),
(3587, 0, 'simple', 'simple_checkout_asap_for_logged', '1', 0),
(3588, 0, 'simple', 'simple_geoip_mode', '1', 0),
(3586, 0, 'simple', 'simple_checkout_asap_for_not_logged', '1', 0),
(3585, 0, 'simple', 'simple_show_back', '0', 0),
(3584, 0, 'simple', 'simple_use_cookies', '1', 0),
(3583, 0, 'simple', 'simple_set_for_reload', 'main_country_id,main_zone_id,main_city,main_postcode,main_address_1', 0),
(3582, 0, 'simple', 'simple_empty_email', '', 0),
(3581, 0, 'simple', 'simple_disable_guest_checkout', '0', 0),
(3580, 0, 'simple', 'simple_debug', '0', 0),
(3579, 0, 'simple', 'simple_steps_summary', '0', 0),
(3577, 0, 'simple', 'simple_common_template', '{help}{left_column}{/left_column}{right_column}{shipping}{payment}{agreement}{/right_column}{customer}{cart}{payment_form}', 0),
(3469, 0, 'cod', 'cod_order_status_id', '1', 0),
(3578, 0, 'simple', 'simple_steps', '0', 0),
(3468, 0, 'cod', 'cod_total', '0.01', 0),
(3463, 0, 'bank_transfer', 'bank_transfer_total', '0.1', 0),
(3473, 0, '', 'autosoft_last_update', '1429561986', 0),
(4315, 0, 'alys_discount_box', 'alys_discount_box_time_delay', '3', 0),
(4316, 0, 'alys_discount_box', 'alys_discount_box_title', 'Заголовок сообщения', 0),
(4317, 0, 'alys_discount_box', 'alys_discount_box_button', 'ок', 0),
(4318, 0, 'alys_discount_box', 'alys_discount_box_text', '​Добр&lt;strong&gt;о пожа&lt;/strong&gt;лова&lt;span style=&quot;color:#FF0000;&quot;&gt;ть&lt;/span&gt;&lt;br /&gt;\r\n&lt;span style=&quot;line-height: 1.6em;&quot;&gt;это текст во&amp;nbsp;&lt;/span&gt;&lt;strong style=&quot;line-height: 1.6em;&quot;&gt;всплывающем&amp;nbsp;&lt;/strong&gt;&lt;span style=&quot;line-height: 1.6em;&quot;&gt;окне&lt;/span&gt;', 0),
(4314, 0, 'alys_discount_box', 'alys_discount_box_status_time', '0', 0),
(4313, 0, 'alys_discount_box', 'alys_discount_box_status_enter', '0', 0),
(10110, 0, 'config', 'config_ftp_username', '', 0),
(10109, 0, 'config', 'config_ftp_port', '21', 0),
(10108, 0, 'config', 'config_ftp_host', 'im-autosoft.ru', 0),
(10107, 0, 'config', 'config_image_cart_height', '47', 0),
(10106, 0, 'config', 'config_image_cart_width', '47', 0),
(10105, 0, 'config', 'config_image_wishlist_height', '47', 0),
(10104, 0, 'config', 'config_image_wishlist_width', '47', 0),
(10103, 0, 'config', 'config_image_compare_height', '90', 0),
(10102, 0, 'config', 'config_image_compare_width', '90', 0),
(10101, 0, 'config', 'config_image_related_height', '80', 0),
(10100, 0, 'config', 'config_image_related_width', '80', 0),
(10099, 0, 'config', 'config_image_additional_height', '74', 0),
(10098, 0, 'config', 'config_image_additional_width', '74', 0),
(10097, 0, 'config', 'config_image_product_height', '80', 0),
(10096, 0, 'config', 'config_image_product_width', '80', 0),
(10095, 0, 'config', 'config_image_popup_height', '500', 0),
(10094, 0, 'config', 'config_image_popup_width', '500', 0),
(10093, 0, 'config', 'config_image_thumb_height', '228', 0),
(10091, 0, 'config', 'config_image_category_height', '80', 0),
(10092, 0, 'config', 'config_image_thumb_width', '228', 0),
(10089, 0, 'config', 'config_icon', 'data/cart.png', 0),
(10090, 0, 'config', 'config_image_category_width', '80', 0),
(10088, 0, 'config', 'config_logo', 'data/logo.png', 0),
(10087, 0, 'config', 'config_return_status_id', '2', 0),
(10086, 0, 'config', 'config_return_id', '0', 0),
(10085, 0, 'config', 'config_commission', '5', 0),
(10084, 0, 'config', 'config_affiliate_id', '4', 0),
(10083, 0, 'config', 'config_stock_status_id', '7', 0),
(10082, 0, 'config', 'config_stock_checkout', '1', 0),
(10081, 0, 'config', 'config_stock_warning', '0', 0),
(10080, 0, 'config', 'config_stock_display', '1', 0),
(10079, 0, 'config', 'config_complete_status_id', '7', 0),
(10078, 0, 'config', 'config_order_status_id', '7', 0),
(10077, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(10076, 0, 'config', 'config_order_edit', '100', 0),
(10075, 0, 'config', 'config_checkout_id', '5', 0),
(9450, 0, 'csv_import', 'csv_import_feed_url', '', 0),
(9449, 0, 'csv_import', 'csv_import_convert_status', '1', 0),
(9448, 0, 'csv_import', 'csv_import_ignore_value', 'VALUE', 0),
(9447, 0, 'csv_import', 'csv_import_ignore_field', 'COLUMN', 0),
(9446, 0, 'csv_import', 'csv_import_update_field', 'model', 0),
(9445, 0, 'csv_import', 'csv_import_type', 'add', 0),
(9444, 0, 'csv_import', 'csv_import_image_append', '', 0),
(9443, 0, 'csv_import', 'csv_import_image_prepend', '', 0),
(9442, 0, 'csv_import', 'csv_import_image_remove', '', 0),
(9441, 0, 'csv_import', 'csv_import_price_multiplier', '', 0),
(9440, 0, 'csv_import', 'csv_import_split_category', ',', 0),
(9439, 0, 'csv_import', 'csv_import_field_tags', '', 0),
(9438, 0, 'csv_import', 'csv_import_field_meta_keyw', '', 0),
(9437, 0, 'csv_import', 'csv_import_field_meta_desc', '', 0),
(9436, 0, 'csv_import', 'csv_import_field_desc', '', 0),
(9435, 0, 'csv_import', 'csv_import_field_quantity_class_id', '', 0),
(9434, 0, 'csv_import', 'csv_import_field_quantity', 'kolvo', 0),
(9433, 0, 'csv_import', 'csv_import_field_image', '', 0),
(9432, 0, 'csv_import', 'csv_import_field_cat', '[["group"]]', 0),
(9431, 0, 'csv_import', 'csv_import_field_manu', 'proizvod', 0),
(9430, 0, 'csv_import', 'csv_import_field_model', 'oe', 0),
(10074, 0, 'config', 'config_guest_checkout', '0', 0),
(9429, 0, 'csv_import', 'csv_import_field_price', 'price', 0),
(9428, 0, 'csv_import', 'csv_import_field_name', 'name', 0),
(9427, 0, 'csv_import', 'csv_import_remote_images', '0', 0),
(9426, 0, 'csv_import', 'csv_import_top_categories', '1', 0),
(9425, 0, 'csv_import', 'csv_import_store', '["0"]', 0),
(9424, 0, 'csv_import', 'csv_import_length_class', '1', 0),
(9423, 0, 'csv_import', 'csv_import_weight_class', '1', 0),
(9422, 0, 'csv_import', 'csv_import_language', '1', 0),
(9421, 0, 'csv_import', 'csv_import_product_status', '1', 0),
(9420, 0, 'csv_import', 'csv_import_subtract', '0', 0),
(9419, 0, 'csv_import', 'csv_import_stock_status_id', '6', 0),
(10073, 0, 'config', 'config_cart_weight', '0', 0),
(10072, 0, 'config', 'config_account_id', '3', 0),
(10071, 0, 'config', 'config_customer_price', '0', 0),
(10070, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1),
(10069, 0, 'config', 'config_customer_group_id', '1', 0),
(10068, 0, 'config', 'config_customer_online', '0', 0),
(10067, 0, 'config', 'config_tax_customer', 'shipping', 0),
(10066, 0, 'config', 'config_tax_default', 'shipping', 0),
(10065, 0, 'config', 'config_vat', '0', 0),
(10064, 0, 'config', 'config_tax', '0', 0),
(10063, 0, 'config', 'config_voucher_max', '1000', 0),
(10062, 0, 'config', 'config_voucher_min', '1', 0),
(10061, 0, 'config', 'config_download', '0', 0),
(10060, 0, 'config', 'config_review_status', '0', 0),
(10059, 0, 'config', 'config_product_count', '0', 0),
(10058, 0, 'config', 'config_admin_limit', '20', 0),
(10057, 0, 'config', 'config_catalog_limit', '15', 0),
(10056, 0, 'config', 'config_weight_class_id', '1', 0),
(10055, 0, 'config', 'config_length_class_id', '1', 0),
(10054, 0, 'config', 'config_currency_auto', '1', 0),
(10053, 0, 'config', 'config_currency', 'RUB', 0),
(10052, 0, 'config', 'config_admin_language', 'ru', 0),
(10051, 0, 'config', 'config_language', 'ru', 0),
(10050, 0, 'config', 'config_zone_id', '2761', 0),
(10049, 0, 'config', 'config_country_id', '176', 0),
(10048, 0, 'config', 'config_layout_id', '6', 0),
(10047, 0, 'config', 'config_template', 'default_autosoft', 0),
(10046, 0, 'config', 'config_meta_description', 'Интернет-магазин', 0),
(10045, 0, 'config', 'config_title', 'Интернет-магазин', 0),
(10044, 0, 'config', 'config_fax', '', 0),
(10043, 0, 'config', 'config_telephone', '8-812-934-52-40', 0),
(10041, 0, 'config', 'config_address', 'Адрес', 0),
(10042, 0, 'config', 'config_email', 'igor@autosoft.ru', 0),
(9418, 0, 'csv_import', 'csv_import_delimiter', ';', 0),
(7206, 0, 'deadcow_seo', 'deadcow_seo_tags_template', '[product_name], [model_name], [manufacturer_name], [categories_names]', 0),
(7205, 0, 'deadcow_seo', 'deadcow_seo_meta_template', '[product_name], [model_name], [manufacturer_name], [categories_names]', 0),
(7204, 0, 'deadcow_seo', 'deadcow_seo_manufacturers_suffix', '.html', 0),
(7202, 0, 'deadcow_seo', 'deadcow_seo_products_suffix', '.html', 0),
(7203, 0, 'deadcow_seo', 'deadcow_seo_manufacturers_template', '[manufacturer_name]', 0),
(7201, 0, 'deadcow_seo', 'deadcow_seo_products_template', '[product_name]', 0),
(7200, 0, 'deadcow_seo', 'deadcow_seo_categories_suffix', '', 0),
(7199, 0, 'deadcow_seo', 'deadcow_seo_categories_template', '[category_name]', 0),
(7207, 0, 'deadcow_seo', 'deadcow_seo_yahoo_id', '', 0),
(7208, 0, 'deadcow_seo', 'deadcow_seo_yahoo_checkbox', '0', 0),
(7209, 0, 'deadcow_seo', 'deadcow_seo_source_language_code', 'ru', 0),
(10040, 0, 'config', 'config_owner', 'Ваше имя', 0),
(10039, 0, 'config', 'config_name', 'Интернет-магазин', 0),
(9802, 0, 'tehnomir', 'tehnomir_status', '1', 0),
(9803, 0, 'tehnomir', 'tehnomir_username', 'alys2007', 0),
(9804, 0, 'tehnomir', 'tehnomir_password', 'lav353', 0),
(10157, 0, '1000_categories_accordion', '1000_categories_accordion_module', 'a:4:{i:0;a:4:{s:9:"layout_id";s:1:"4";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"0";}i:1;a:4:{s:9:"layout_id";s:1:"1";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"0";}i:2;a:4:{s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"0";}i:3;a:4:{s:9:"layout_id";s:1:"2";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:
86;s:21:"report/customer_order";i:87;s:22:"report/customer_reward";i:88;s:24:"report/product_purchased";i:89;s:21:"report/product_viewed";i:90;s:18:"report/sale_coupon";i:91;s:17:"report/sale_order";i:92;s:18:"report/sale_return";i:93;s:20:"report/sale_shipping";i:94;s:15:"report/sale_tax";i:95;s:14:"sale/affiliate";i:96;s:12:"sale/contact";i:97;s:11:"sale/coupon";i:98;s:13:"sale/customer";i:99;s:20:"sale/customer_ban_ip";i:100;s:19:"sale/customer_group";i:101;s:10:"sale/order";i:102;s:11:"sale/return";i:103;s:12:"sale/voucher";i:104;s:18:"sale/voucher_theme";i:105;s:15:"setting/setting";i:106;s:13:"setting/store";i:107;s:16:"shipping/auspost";i:108;s:17:"shipping/citylink";i:109;s:14:"shipping/fedex";i:110;s:13:"shipping/flat";i:111;s:13:"shipping/free";i:112;s:13:"shipping/item";i:113;s:23:"shipping/parcelforce_48";i:114;s:15:"shipping/pickup";i:115;s:19:"shipping/royal_mail";i:116;s:12:"shipping/ups";i:117;s:13:"shipping/usps";i:118;s:15:"shipping/weight";i:119;s:11:"tool/backup";i:120;s:16:"tool/csv_import-";i:121;s:17:"tool/csv_import.0";i:122;s:15:"tool/csv_import";i:123;s:14:"tool/error_log";i:124;s:12:"total/coupon";i:125;s:12:"total/credit";i:126;s:14:"total/handling";i:127;s:16:"total/klarna_fee";i:128;s:19:"total/low_order_fee";i:129;s:12:"total/reward";i:130;s:14:"total/shipping";i:131;s:15:"total/sub_total";i:132;s:9:"total/tax";i:133;s:11:"total/total";i:134;s:13:"total/voucher";i:135;s:9:"user/user";i:136;s:20:"user/user_permission";}}');
...
(66, 176, 0, 5, '2014-08-08 16:42:31', '0000-00-00 00:00:00');
...
ALTER TABLE `oc_category_path`
  ...
  ADD KEY `beget_auto_idx_1` (`path_id`);
...
--
-- Индексы таблицы `oc_menuitems`
--
ALTER TABLE `oc_menuitems`
  ADD PRIMARY KEY (`menu_item_id`);

--
-- Индексы таблицы `oc_menuitem_descriptions`
--
ALTER TABLE `oc_menuitem_descriptions`
  ADD PRIMARY KEY (`menu_item_id`,`language_id`);

--
-- Индексы таблицы `oc_menus`
--
...
ALTER TABLE `oc_product`
  ...
  ADD KEY `beget_auto_idx_1` (`status`,`date_available`);
...
ALTER TABLE `oc_product_description`
  ...
  ADD KEY `name` (`name`),
  ADD KEY `beget_auto_idx_1` (`language_id`),
  ADD KEY `beget_auto_idx_2` (`name`);
...
ALTER TABLE `oc_product_to_category`
  ...
  ADD KEY `beget_auto_idx_1` (`category_id`);
...
ALTER TABLE `oc_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`),
  ADD KEY `beget_auto_idx_1` (`store_id`);
...
--
ALTER TABLE `oc_currency`
  MODIFY `currency_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=35;
--
...
--
-- AUTO_INCREMENT для таблицы `oc_discount`
--
ALTER TABLE `oc_discount`
  MODIFY `discount_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
-- AUTO_INCREMENT для таблицы `oc_menuitems`
--
ALTER TABLE `oc_menuitems`
  MODIFY `menu_item_id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `oc_menus`
--
ALTER TABLE `oc_menus`
...
--
ALTER TABLE `oc_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10160;
--
