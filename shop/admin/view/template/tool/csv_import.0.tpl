	...
	<div id="tab_map">
		...
		<tr>
			<td colspan="3"><table>
				...
				<tr><td style="width:200px;"><?php echo $text_field_import_price; ?></td><td><input type="text" name="csv_import_field_import_price" value="<?php echo $csv_import_field_import_price; ?>"></td></tr>
				...
				<tr><td style="width:200px;"><?php echo $text_field_quantity_class_id; ?></td><td><input type="text" name="csv_import_field_quantity_class_id" value="<?php echo $csv_import_field_quantity_class_id; ?>"></td></tr>
				<tr><td style="width:200px;"><?php echo $text_field_option; ?></td><td><input type="text" name="csv_import_field_option" value="<?php echo $csv_import_field_option; ?>"></td></tr>
