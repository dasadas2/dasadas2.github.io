	...
	*/
    ...
    public function watermark($file, $position = 'center') {
       // $watermark = $this->create($file);
        $watermark = imagecreatefrompng($file);//ig source http://itheap.info/blog/opencart/117.html    watermark.png
		...
		imagecopy($this->image, $watermark, $watermark_pos_x, $watermark_pos_y, 0, 0, $watermark_width, $watermark_height); //ig
