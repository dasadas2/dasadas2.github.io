...
class ModelModuleDeadcowSEO extends Model {
    public function generateCategories($template, $suffix, $source_langcode, $overwrite) {
    ...
    public function generateProductsMetaKeywords($template, $yahooID = null, $source_langcode) {
    ...
    private function makeSlugsRUS($string, $maxlen = 0, $noSpace = true, $source_langcode = null) {
        global $session;
        $newStringTab = array();
