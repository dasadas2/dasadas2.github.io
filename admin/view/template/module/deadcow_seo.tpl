        ...
        <div class="content">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="overwrite_categories">
                                <option value="overwrite"><?php echo $overwrite;?></option>
                    ...
                    <tr>
                        <td><?php echo $products_meta_keywords;?></td>
                        <td colspan="2">
                            ...
                            <div class="template-info"><?php echo $get_yahoo_id;?></div>
                            <br/>
                            <?php } else { ?>
                            ...
                            <br/><?php echo $warning_clear_meta;?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $categories_meta_keywords;?></td>
                        <td colspan="2">
                            <label for="categories_meta_template"><?php echo $template;?> </label>
                            <select id="categories_meta_template" name="categories_meta_template">
                            ...
                            <button type="submit" name="categories_meta_keywords" value="categories_meta_keywords"><?php echo $generate;?></button>
                            <br/><?php echo $warning_clear_meta;?>
                        </td>
                    </tr>
                    <tr>
