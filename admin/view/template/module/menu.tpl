...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons">
        <a onclick="location = '<?php echo $menu; ?>';" class="button"><span><?php echo $button_menu; ?></span></a>
        &nbsp;&nbsp;&nbsp;
...
<?php /*
        <tr>
          ...
          <td><?php if ($menu_link) { ?>
            <input type="radio" name="menu_link" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="menu_link" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="menu_link" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="menu_link" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?>
          </td>
        </tr>
*/ ?>
        <tr>
          <td><?php echo $entry_hide_menu; ?></td>
          <td><?php if ($menu_hide_menu) { ?>
            <input type="radio" name="menu_hide_menu" value="1" checked="checked" />
            <?php echo $text_yes; ?>
            <input type="radio" name="menu_hide_menu" value="0" />
            <?php echo $text_no; ?>
            <?php } else { ?>
            <input type="radio" name="menu_hide_menu" value="1" />
            <?php echo $text_yes; ?>
            <input type="radio" name="menu_hide_menu" value="0" checked="checked" />
            <?php echo $text_no; ?>
            <?php } ?>
          </td>
        </tr>
...
<?php /*
        <tr>
          ...
          <td><?php if ($menu_sort_by == 'name') { ?>
            <input type="radio" name="menu_sort_by" value="name" checked="checked" />
            <?php echo $text_sort_by_name; ?>
            <input type="radio" name="menu_sort_by" value="sort_order" />
            <?php echo $text_sort_by_order; ?>
            <?php } else { ?>
            <input type="radio" name="menu_sort_by" value="name" />
            <?php echo $text_sort_by_name; ?>
            <input type="radio" name="menu_sort_by" value="sort_order" checked="checked" />
            <?php echo $text_sort_by_order; ?>
            <?php } ?>
          </td>
        </tr>
