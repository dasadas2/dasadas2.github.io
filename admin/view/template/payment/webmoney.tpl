    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input type="text" name="webmoney_merch_r" value="<?php echo $webmoney_merch_r; ?>" />
        ...
        <tr>
          ...
          <td><input type="text" name="webmoney_secret_key" value="<?php echo $webmoney_secret_key; ?>" />
        ...
        <tr>
          ...
          <td><select name="webmoney_order_status_id">
              <?php foreach ($order_statuses as $order_status) { ?>
              <?php if ($order_status['order_status_id'] == $webmoney_order_status_id) { ?>
        ...
        <tr>
          ...
          <td><select name="webmoney_geo_zone_id">
              <option value="0"><?php echo $text_all_zones; ?></option>
              <?php foreach ($geo_zones as $geo_zone) { ?>
              <?php if ($geo_zone['geo_zone_id'] == $webmoney_geo_zone_id) { ?>
        ...
        <tr>
          ...
          <td><select name="webmoney_status">
              <?php if ($webmoney_status) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="webmoney_sort_order" value="<?php echo $webmoney_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
