        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $column_sort_order; ?></a>
              <td class="left"><?php echo $column_min_price; ?></a>
              <td class="left"><?php echo $column_max_price; ?></a>
              <td class="left"><?php echo $column_percent; ?></a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $discount['min_price']; ?></td>
              <td class="left"><?php echo $discount['max_price']; ?></td>
              <td class="left"><?php echo $discount['percent']; ?></td>
