...
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="lprice"><a class="top"><?php echo $text_lprice; ?></a>
        <ul class="lprice">
          <li><a style="width: 222px !important;" href="<?php echo $uprice; ?>"><?php echo $text_uprice; ?></a></li>
          <li><a style="width: 222px !important;" href="<?php echo $discount; ?>"><?php echo $text_discount; ?></a></li>
          <li><a style="width: 222px !important;" href="<?php echo str_replace('tool/backup', 'tool/csv_import', $backup); ?>">Загрузить прайс</a></li>
        </ul>
      </li>
      <!--загрузка прайсов поставщиков-->      
      ...
      <li id="help"><a class="top"><?php echo $text_help; ?></a>
        <ul>
        <li><a onclick="window.open('http://www.autosoft.ru');"><?php echo $text_opencart; ?></a></li>
        </ul>
      </li>
    </ul>
